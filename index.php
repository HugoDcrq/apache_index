...
<head>
  ...
  * {
  ...
  body, html {
    ...
    background-image: url("http://www.assembleedesmedias.fr/wp-content/uploads/2014/11/FOND-ETOILE-web-HD.jpg");
...
<body>
  ...
  <br><br><br><br>
  <h1 class="localhost-title">LOCALHOST</h1>

  <div class="main_page explorateur">
            ...
            while( $file = readdir($directory) )
            {
              if (is_file($rootdir . "/" . $currentdir . "/" . $file) )
              {
                ...
                echo "<tr><td width=30 height=35>";
                  echo "</td><td>";
                  echo "<a target=\"_blank\" href=\"/" . $currentdir . "/" . $file . "\">" . $file . "</a>";
